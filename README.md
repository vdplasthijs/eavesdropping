...
Please note: because all networks are saved, the repository is quite large. Alternatively, you can download everything except the `models/` folder to exclude pre-trained networks. 
